            ...
            <div className='overflow-hidden '>
                ...
                <div className=" bg-gray-900 xl:hidden flex justify-between w-full  p-6 items-center ">
                    <div className="flex justify-between  items-center space-x-3">
                        ...
                        <p className="text-2xl leading-6 text-white">Admin Panel</p>
                    </div>
                ...
                <div id="Main" className={`${show ? 'translate-x-0' : 'hidden'} xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start  w-full sm:w-64 bg-gray-900 flex-col`}>
                    ...
                    <div className="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
                        <div className="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-indigo-400  text-white rounded ">


                            <div className="flex flex-col justify-start items-center    w-full  ">
                                <div className="focus:outline-none focus:text-indigo-400  text-white flex justify-between items-center w-full py-5 space-x-14  ">
                                    <p className="text-sm leading-5  uppercase">Books Management </p>

                                </div>
                                <div id="menu1" className={`flex justify-start  flex-col w-full md:w-auto items-start pb-1 `}>
                                    <div to={'/dashbord/panel'} className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                                        ...
                                        <NavLink to={'/dashbord/panel'} className="text-base leading-4  ">Add Book</NavLink>
                                    </div>
                                    <div className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <NavLink to={'/dashbord/removebook'} className="text-base leading-4  ">Remove Book</NavLink>
                                    </div>
                                    <div className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 w-full md:w-52">
                                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <NavLink className="text-base leading-4  " to={'/dashbord/updatebook'}>Update Book</NavLink>
                                    </div>
                                    <div className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <NavLink className="text-base leading-4  ">Notifications</NavLink>
                                    </div>
                                    <div className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <NavLink className="text-base leading-4  ">Passwords</NavLink>
                                    </div>
                                    <div className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <NavLink className="text-base leading-4  ">Goals</NavLink>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative flex flex-col justify-between items-center h-full pb-6   px-6  w-full  space-y-32 ">


                        <div id='avtar' className="absolute  flex justify-between items-center w-full">
