...
export default function Contact() {
    return (
        <>
            ...
            <div id="contact" className=" text-gray-100 px-8 py-20">
                <div id='contact-main'
                    className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  text-gray-100 rounded-lg shadow-lg">
